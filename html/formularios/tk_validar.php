	...
	<body>
        ...
        <div class='table-responsive'>
            <table align='center' cellpadding='10px' cellspacing='20px'>
                <tr align='center'>
                    <td>Un administrador se encuentra evaluando la veracidad de los datos, por favor sea paciente.</td>
                </tr>
                <tr align='center'>
                    <td>Una vez verificado, podrá empezar a animar sus fiestas comprando bebidas y botanas en<br><b>Trinken</b></td>
                </tr>
            </table>
        </div>
