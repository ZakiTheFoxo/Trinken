	...
	<body>
        ...
        <p><?php 
            ...
            if(mysqli_num_rows($result) > 0){
                echo "<div class='table-responsive'><table width='1000px' align='center' cellpadding='10px' cellspacing='20px'><tr><td colspan='8' align='center'><b>Trinken Repartidores</b></td></tr>";
                ...
                while($row = mysqli_fetch_array($result)){
                    printf("<form method='post' action='tk_editar_repartidor2.php'><input type='hidden' name='id' value='".$row['id']."'><tr class='search' border='1'><td>%d</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%d</td><td>%s</td><td><button class='add' value='editar'>Editar</button></td></tr></form>", 
